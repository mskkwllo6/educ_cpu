...
module imem(input [`PCS:0] pc, output logic [`CMDS:0] o);
	always_comb
		...
		////計算
		6'h07: o = 16'b0000_10_10_0_000_00_01;//r2<-a+b 0 0 0 0 1 0 rw> F op--> a-> b->
		6'h08: o = 16'b0000_10_00_0_010_00_01;//r0<-r1
		6'h09: o = 16'b0000_10_01_0_010_00_10;//r1<-r2
		...
		6'h0b: o = 16'b0100_1101_1111_1100;//補数表現-4
